...
var footers={
	...
	'<div class="content">'+
	'<div class="content-item footer-bodys" style="background-color:#2c333f;">'+
	...
	'</ul></div>'+
	'<div class="trademark">京ICP备08001421号 京公网安备110108007702 Copyright @ 2016-2017  博学谷 All Rights Reserved <span style="margin-right:5px;"></span></div>'+
	'</div></div></footer>',
...
//	RequestService("/online/user/isAlive", "GET", null, function (data) {///online/user/isAlive
	...
	$(".trademark span").after($("#cnzz_stat_icon_1260713417"));
// });
//})
//==========================================================================================
//左侧导航栏点击添加缓存
